...
import {View, StyleSheet, TextInput, Dimensions, ScrollView, Switch, Text} from 'react-native';
import HeaderWithBackButton from '../headers/HeaderWithBackButton';

export default class ApplicantFormTwo extends React.Component{
    render(){
        return(
            <View style={{flex: 1}}>
                <HeaderWithBackButton navigation={this.props.navigation} headerTitle="Add Applicant" subTitle="Use Aadhar Scan" />
